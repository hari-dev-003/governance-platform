"""PostgreSQL connector — fully functional, uses asyncpg."""
    ...
    async def test_connection(self) -> ConnectionTestResult:
        try:
            ...
            return ConnectionTestResult(
                success=True, message="Connected", details={"version": version}
            )
        ...
        try:
            ...
            for s in schemas:
                ...
                for t in tables:
                    ...
                    for c in cols:
                        assets.append(DiscoveredAsset(
                            external_id=f"{table_id}.{c['column_name']}",
                            name=c["column_name"], asset_type="column", parent_id=table_id,
                            metadata={
